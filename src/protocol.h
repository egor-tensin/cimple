...
int request_create_finished_run(struct jsonrpc_request**, int run_id, const struct process_output*);
int request_parse_finished_run(const struct jsonrpc_request*, int* run_id, struct process_output**);
